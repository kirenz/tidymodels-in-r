---
title: "Tidymodels IV: Recipes, Workflows and Models"
subtitle: "Learn how to build classification models with tidymodels, Part 4"
...
Let's save the sample data (we will use it again in the following tutorial):

```{r}

write_csv(flight_data, file = "flight_Data.csv")
